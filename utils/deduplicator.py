...
def _normalize_title(title: str) -> str:
    ...
    stop_words = {
        ...
        "после", "между", "через", "без", "около", "против", "вместо", "вроде", "вроде",
...
def _extract_key_entities(title: str) -> Set[str]:
    ...
    common = {"the", "and", "for", "new", "now", "today", "this", "that", "with", "from",
              "more", "over", "after", "first", "last", "year", "week", "day", "time",
              "said", "says", "say", "will", "about", "into", "than", "only", "other",
              "some", "come", "could", "state", "still", "while", "made", "make", "well",
              "where", "much", "before", "right", "too", "any", "same", "tell", "very",
              "when", "much", "would", "there", "their", "what", "your", "all", "each",
              "which", "she", "do", "how", "if", "out", "up", "so", "can", "her", "him",
              "his", "has", "had", "my", "did", "get", "its", "our", "us", "may", "use",
              "man", "men", "way", "old", "see", "him", "two", "how", "its", "oil", "sit",
              "set", "run", "eat", "far", "sea", "eye", "ago", "off", "too", "old", "tell",
              "very", "when", "much", "would", "there", "their", "what", "say", "she", "each",
              "which", "do", "how", "if", "up", "out", "many", "then", "them", "these", "some",
              "her", "would", "make", "like", "into", "him", "has", "two", "more", "go", "no",
...
_NAME_MAP = {
    # Политики
    "трамп": "trump", "трампа": "trump", "трампу": "trump",
    "байден": "biden", "байдена": "biden", "байдену": "biden",
    "путин": "putin", "путина": "putin", "путину": "putin",
    "зеленский": "zelensky", "зеленского": "zelensky",
    "си": "xi", "цзиньпин": "xi",
    "натаньяху": "netanyahu",
    "эрдоган": "erdogan",
    "макрон": "macron",
    "сун": "sunak", "стармер": "starmer",
    "трюдо": "trudeau",
    "моди": "modi",
    "лula": "lula",
    "мбс": "mbs",
    # Страны / регионы
    "россия": "russia", "рф": "russia", "российск": "russia",
    "сша": "usa", "америка": "usa", "американск": "usa",
    "китай": "china", "китая": "china", "китайск": "china", "китайский": "china", "китайские": "china",
    "china": "china", "chinese": "china", "кндр": "nkorea",
    "украина": "ukraine", "украинск": "ukraine",
    "европа": "europe", "европейск": "europe", "ес": "eu", "евросоюз": "eu",
    "израиль": "israel", "израильск": "israel",
    "иран": "iran", "иранск": "iran",
    "индия": "india", "индийск": "india",
    "япония": "japan", "японск": "japan",
    "германия": "germany", "германск": "germany",
    "франция": "france", "французск": "france",
    "британия": "uk", "великобритания": "uk", "британск": "uk",
    "турция": "turkey", "турц": "turkey",
    "бразилия": "brazil", "бразильск": "brazil",
    "корея": "korea", "корейск": "korea",
    "саудовская аравия": "saudi", "саудовск": "saudi",
    "оаэ": "uae",
    "канада": "canada", "канадск": "canada",
    "австралия": "australia", "австралийск": "australia",
    "швейцария": "switzerland", "швейцарск": "switzerland",
    # Компании / бренды
    ...
    "майкрософт": "microsoft", "microsoft": "microsoft",
    "амазон": "amazon", "amazon": "amazon",
    "мета": "meta", "meta": "meta",
    "нвидиа": "nvidia", "nvidia": "nvidia",
    "опенай": "openai", "openai": "openai",
    "чатгпт": "chatgpt", "chatgpt": "chatgpt",
    "самсунг": "samsung",
    "хендай": "hyundai",
    "бинанс": "binance",
    "койнбейс": "coinbase",
    ...
    "арамко": "aramco",
    # Финансовые термины
    "ставка": "rate", "ставки": "rate",
    "тариф": "tariff", "тарифы": "tariff",
    "пошлина": "tariff", "пошлины": "tariff",
    "санкции": "sanction", "санкция": "sanction",
    "инфляция": "inflation",
    "дефолт": "default",
    "рецессия": "recession",
    "кризис": "crisis",
...
def _extract_translatable_keywords(title: str) -> Set[str]:
    ...
    for name in names:
        n = name.lower()
        if len(n) > 2 and n not in {"the", "and", "for", "new", "now", "today", "this", "that", "with", "from",
                                     "more", "over", "after", "first", "last", "year", "week", "day", "time",
                                     "said", "says", "say", "will", "about", "into", "than", "only", "other"}:
            ...
            for past_entities, past_time in _topic_history:
                if past_time > cooldown_cutoff:
                    ...
                    if len(common_entities) >= 2:
                        logger.info(f"⏳ Topic cooldown (6h): '{title[:60]}...' — та же тема, пропускаем")
                        skipped += 1
                        break
            else:
