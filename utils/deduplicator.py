...
_NAME_MAP = {
    ...
    "теракте": "terror_attack",
    "теракта": "terror_attack",
    "теракту": "terror_attack",
    "терактом": "terror_attack",
    "теракты": "terror_attack",
    # Города и регионы (канонизация падежных форм)
    "брянск": "bryansk",
    "брянском": "bryansk",
    "брянской": "bryansk",
    "брянска": "bryansk",
    ...
    "петербургу": "petersburg",
    "ленинград": "petersburg",
    "ленинграда": "petersburg",
    "ленинграде": "petersburg",
